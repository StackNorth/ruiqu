...
<Nonce><![CDATA[%s]]></Nonce>
	...
	protected function setCache($cachename,$value,$expired){
		...
		$val = Service::factory('VariableService')->setVariable($cachename,$value);
		if($val){
			return true;
		}else{
			return false;
	...
	protected function getCache($cachename){
		...
		$data = Service::factory('VariableService')->getVariable($cachename);
		if($data){
			return $data;
		}else{
			return false;
	...
	protected function removeCache($cachename){
		...
		$result = Service::factory('VariableService')->delVariable($cachename);
		return $result;
	}
